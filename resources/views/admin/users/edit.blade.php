...
<div class="container">
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Nạp credit</a>
        </li>
    </ul>
    <div class="tab-content" id="pills-tabContent">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <select class="form-control" multiple="" name="roles[]">
                            <option value="user" selected>Học viên</option>
        ...
         {!! Form::model($user, ['method' => 'POST','route' => ['naptien', $user->id]]) !!}
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Nhập số tiền:</strong>
                        {!! Form::text('credit', '0.000', array('placeholder' => '0.000','class' => 'form-control', 'value' => 0)) !!}
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
